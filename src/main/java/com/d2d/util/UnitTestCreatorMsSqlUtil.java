...
@Component
public class UnitTestCreatorMsSqlUtil {
    ...
    public String curdUnitTestCaseCreation(Table table, String tableClassName1, List<Column> columns) {
        ...
        for (Column column : columns) {
            ...
            if (column.getDatatype().equalsIgnoreCase("BIGINT") || column.getDatatype().equalsIgnoreCase("INT") ||
                    column.getDatatype().equalsIgnoreCase("TINYINT")||
                    column.getDatatype().equalsIgnoreCase("SMALLINT")) {
                types = "int";
                values = "1";
            }  else if (column.getDatatype().equalsIgnoreCase("VARCHAR") || column.getDatatype().equalsIgnoreCase("CHAR") ||
                    column.getDatatype().equalsIgnoreCase("NCHAR") || column.getDatatype().equalsIgnoreCase("NTEXT") ||
                    column.getDatatype().equalsIgnoreCase("NVARCHAR") || column.getDatatype().equalsIgnoreCase("TEXT") ) {
                types = "String";
                values = "";
            } else if (column.getDatatype().equalsIgnoreCase("DECIMAL") ||column.getDatatype().equalsIgnoreCase("NUMERIC") ||
                    column.getDatatype().equalsIgnoreCase("FLOAT") || column.getDatatype().equalsIgnoreCase("REAL") )
            {
                types = "double";
                values = "0.0";
            } else if (column.getDatatype().equalsIgnoreCase("BIT")) {
                types = "boolean";
                values = "false";
            }
        }
    ...
    public String curdUnitTestCommonData(Table table, String tableClassName1, List<Column> columns) {
        ...
        for (Column column : columns) {
            ...
            if (column.getKeytype() == null || column.getKeytype().equalsIgnoreCase("PK")) {
                if (column.getDatatype().equalsIgnoreCase(Constant.SMALLINT) || column.getDatatype().equalsIgnoreCase("BIGINT") ||
                        column.getDatatype().equalsIgnoreCase("INT") || column.getDatatype().equalsIgnoreCase("TINYINT")) {
                    values = "1";
                }
                else if (column.getDatatype().equalsIgnoreCase("VARCHAR") || column.getDatatype().equalsIgnoreCase("CHAR") ||
                        column.getDatatype().equalsIgnoreCase("NCHAR") || column.getDatatype().equalsIgnoreCase("NTEXT") ||
                ...
                if (column.getDatatype().equalsIgnoreCase(Constant.SMALLINT) || column.getDatatype().startsWith("TINYINT") || column.getDatatype().equalsIgnoreCase("int") || column.getDatatype().equalsIgnoreCase("BIGINT") || column.getDatatype().equalsIgnoreCase(Constant.SHORT_SMALL) || column.getDatatype().equalsIgnoreCase("Boolean")) {
        ...
        for (Column column : columns) {
            ...
            if (column.getKeytype() == null || column.getKeytype().equalsIgnoreCase("PK")) {
                ...
                if (column.getDatatype().equalsIgnoreCase(Constant.SMALLINT) || column.getDatatype().
                        startsWith("TINYINT") || column.getDatatype().equalsIgnoreCase("int")
                        || column.getDatatype().equalsIgnoreCase("BIGINT") ||
                        column.getDatatype().equalsIgnoreCase(Constant.SHORT_SMALL) ||
                        column.getDatatype().equalsIgnoreCase("Boolean")) {
