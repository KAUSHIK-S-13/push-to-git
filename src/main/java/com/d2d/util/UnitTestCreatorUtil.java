...
@Component
public class UnitTestCreatorUtil {
    @Autowired
    ...
    public String curdUnitTestCaseCreation(Table table, String tableClassName1, List<Column> columns) {
        ...
        for (Column column : columns) {
            ...
            if (column.getDatatype().equalsIgnoreCase(Constant.SMALLINT) || column.getDatatype().equalsIgnoreCase("INT") ||
    ...
    public String curdUnitTestCommonData(Table table, String tableClassName1, List<Column> columns) {
        ...
        for (Column column : columns) {
            ...
            if (column.getKeytype() == null || column.getKeytype().equalsIgnoreCase("PK")) {
                ...
                if (column.getDatatype().equalsIgnoreCase(Constant.SMALLINT) || column.getDatatype().startsWith("TINYINT") || column.getDatatype().equalsIgnoreCase("int") || column.getDatatype().equalsIgnoreCase("Long") || column.getDatatype().equalsIgnoreCase(Constant.SHORT_SMALL) || column.getDatatype().equalsIgnoreCase("Boolean")) {
        ...
        for (Column column : columns) {
            ...
            if (column.getKeytype() == null || column.getKeytype().equalsIgnoreCase("PK")) {
                ...
                if (column.getDatatype().equalsIgnoreCase(Constant.SMALLINT) || column.getDatatype().
                        ...
                        || column.getDatatype().equalsIgnoreCase("Long") ||
