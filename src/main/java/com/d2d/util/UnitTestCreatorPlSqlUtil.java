...
@Component
public class UnitTestCreatorPlSqlUtil {
    ...
    public String curdUnitTestCaseCreation(Table table, String tableClassName1, List<Column> columns) {
        ...
        for (Column column : columns) {
            ...
            if (column.getDatatype().equalsIgnoreCase("INT8") || column.getDatatype().equalsIgnoreCase("INT4") ||
                    column.getDatatype().equalsIgnoreCase("INT2")||
                    column.getDatatype().equalsIgnoreCase("BIT")) {
                types = "int";
                values = "1";
            }  else if (column.getDatatype().equalsIgnoreCase("VARCHAR")||column.getDatatype().equalsIgnoreCase("TEXT")||
                    column.getDatatype().equalsIgnoreCase("CHAR")||column.getDatatype().equalsIgnoreCase("NAME")) {
                types = "String";
                values = "";
            } else if (column.getDatatype().equalsIgnoreCase("NUMERIC")||column.getDatatype().equalsIgnoreCase("FLOAT8")||
                    column.getDatatype().equalsIgnoreCase("FLOAT4")) {
                types = "double";
                values = "0.0";
            } else if (column.getDatatype().equalsIgnoreCase("BOOL")) {
                types = "boolean";
                values = "false";
            }
        }
    ...
    public String curdUnitTestCommonData(Table table, String tableClassName1, List<Column> columns) {
        ...
        for (Column column : columns) {
            ...
            if (column.getKeytype() == null || column.getKeytype().equalsIgnoreCase("PK")) {
                ...
                if (column.getDatatype().equalsIgnoreCase("INT8") || column.getDatatype().equalsIgnoreCase("INT4") ||
                        column.getDatatype().equalsIgnoreCase("INT2")||
                        column.getDatatype().equalsIgnoreCase("BIT")|| column.getDatatype().equalsIgnoreCase(Constant.SHORT_SMALL) || column.getDatatype().equalsIgnoreCase("BOOL")) {
